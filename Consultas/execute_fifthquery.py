...
JOIN "Country_Power Source" CP ON  CP."Country_ID_Country" = C."ID_Country"  AND I."Year" = CP."Year"
JOIN "Sector_Country" SC ON SC."Country_ID" = C."ID_Country" AND I."Year" = SC."Year"
